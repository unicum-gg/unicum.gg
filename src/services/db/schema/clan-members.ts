...
export const clanMembers = pgTable(
  "clan_members",
  {
    ...
    personalRating: integer("personal_rating").notNull(),

    overallBattles: integer("overall_battles").notNull(),
    overallWinsPct: real("overall_wins_pct").notNull(),
    overallDamagePerBattle: real("overall_damage_per_battle").notNull(),
    overallExpPerBattle: real("overall_exp_per_battle").notNull(),
    overallFragsPerBattle: real("overall_frags_per_battle").notNull(),
    overallBattlesPerDay: real("overall_battles_per_day").notNull(),
