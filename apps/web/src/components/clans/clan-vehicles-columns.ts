...
// Column widths/alignment mirroring ClanVehiclesTable, for the on-demand loading
...
// array — a plain value can't cross the "use client" boundary as a value.
export const VEHICLES_SKELETON_COLUMNS: SkeletonColumn[] = [
