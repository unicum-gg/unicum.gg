...
import { PlayerSearchPopover } from "@/components/players/compare/player-search-popover";
...
export function CompareWithButton({
  ...
  const { t } = useTranslation("components/players/detail/compare-with-button");
  ...
  return (
    <PlayerSearchPopover
      ...
      triggerAriaLabel={t("compare-with-another-player")}
