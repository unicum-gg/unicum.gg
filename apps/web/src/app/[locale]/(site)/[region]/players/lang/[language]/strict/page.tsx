...
export async function generateMetadata({
  ...
  const { t } = await getTranslation("app/players/lang/strict/page", locale);
...
export default async function Page({
  ...
  if (region === Region.EU) {
    redirect(localizePath(ROUTES.PLAYERS_BY_LANGUAGE(Region.EU, language, true), locale));
  }
  return (
    <PlayersLandingView locale={locale} region={region} language={language} strict={true} />
  );
}
