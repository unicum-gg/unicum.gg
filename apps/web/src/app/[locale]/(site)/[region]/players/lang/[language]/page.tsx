...
export default async function Page({
  ...
  if (region === Region.EU) {
    redirect(localizePath(ROUTES.PLAYERS_BY_LANGUAGE(Region.EU, language), locale));
  }
  return (
    <PlayersLandingView locale={locale} region={region} language={language} strict={false} />
  );
}
