...
export async function generateMetadata({
  ...
  const { t } = await getTranslation("app/clans/lang/page", locale);
...
export default async function Page({
  ...
  if (region === Region.EU) {
    redirect(localizePath(ROUTES.CLANS_BY_LANGUAGE(Region.EU, language), locale));
  }
  return (
    <ClansLandingView region={region} language={language} locale={locale} strict={false} />
  );
}
