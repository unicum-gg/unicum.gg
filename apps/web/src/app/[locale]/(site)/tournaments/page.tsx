...
import { renderTournaments } from "@/app/[locale]/(site)/[region]/tournaments/page";
...
export default async function TournamentsShortcut({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  // which points here.
  return renderTournaments(Region.EU, locale);
}
