// WoT store gold-bundle prices per region, for the tank real-money cost
// estimate. Prices are per-region because WG charges different currencies and
// amounts on EU / NA / Asia. Each table is captured from that region's store
...
/**
 * Per-region pricing. Callers hide the money estimate for a region with no
 * table rather than mispricing it in the wrong currency.
 */
const GOLD_PRICING: Record<Region, RegionGoldPricing | null> = {
