// One-off backfill of the map change history from the wot-src mirror git log.
...
//   pnpm --filter @unicum.gg/web exec tsx scripts/backfill-map-history.ts --wipe
...
import { backfillMapHistory } from "@unicum.gg/core/wargaming/wot/maps/history-backfill";
